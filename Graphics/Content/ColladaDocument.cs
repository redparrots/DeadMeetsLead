    ...
    public class ColladaDocument
    {
        ...
        public class Asset
        {
            public class Contributor
            {
                ...
                public Contributor() { }
                public Contributor(ColladaDocument doc, XmlNode node)
                {
            ...
            private Asset() { }
            public Asset(ColladaDocument doc, XmlNode node)
            {
        ...
        public class Element
        {
            ...
            private Element() { }
            public Element(ColladaDocument doc, XmlNode node)
            {
                // get id and name
        ...
        public class Extra : Element
        {
            ...
            public Extra(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class Array<T> : Element
        {
            ...
            public Array(ColladaDocument doc, XmlNode arrayElement)
        ...
        public class Param
        {
            ...
            public Param(ColladaDocument doc, XmlNode node)
            {
                index = doc.sIndex++;
                name = doc.Get<string>(node, "name", null);
        ...
        public class Annotate
        {
            ...
            private Annotate() { }
            public Annotate(ColladaDocument doc, XmlNode node)
            {
                name = doc.Get<string>(node, "name", null);
        ...
        public class Sampler2D : Sampler3D
        {
            ...
            public Sampler2D(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
            }
        }
        ...
        public class Sampler1D : Sampler3D
        {
            ...
            public Sampler1D(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
            }
        }
        ...
        public class Sampler3D : IFxBasicTypeCommon
        {
            ...
            public Sampler3D(ColladaDocument doc, XmlNode node)
            {
                foreach (XmlNode child in node.ChildNodes)
                {
                    switch (child.Name)
        ...
        public class Surface : IFxBasicTypeCommon
        {
            ...
            private Surface() { }
            public Surface(ColladaDocument doc, XmlNode node)
            {
                foreach (XmlNode child in node.ChildNodes)
                {
                    switch (child.Name)
        ...
        public class NewParam
        {
            ...
            private NewParam() { }
            public NewParam(ColladaDocument doc, XmlNode node)
            {
                sid = doc.Get<string>(node, "sid", null);
        ...
        public class Accessor
        {
            ...
            private Accessor() { }
            public Accessor(ColladaDocument doc, XmlNode node)
            {
        ...
        public class Source : Element, ISourceOrVertices
        {
            ...
            public Source(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class Input
        {
            ...
            public int set;
            private Input() {}
            public Input(ColladaDocument doc, XmlNode node)
            {
        ...
        public class Vertices : Element, ISourceOrVertices
        {
            ...
            //private vertices() { }
            public Vertices(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class Locator
        {
            ...
            private Uri url;
            private Locator() { }
            public Locator(ColladaDocument doc, XmlNode node)
            {
                string path = null;
        ...
        public class Color : IColorOrTexture
        {
            ...
            public float[] floats;
            private Color() { }
            public Color(ColladaDocument doc, XmlNode node)
            {
                sid = doc.Get<string>(node, "sid", null);
        ...
        {   
            ...
            public TransparentFloat(ColladaDocument doc, XmlNode node)
                : base(doc, node) 
            { 
        ...
        {
            public string opaque;
            public TransparentTexture(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
                opaque = doc.Get<string>(node, "opaque", "A_ONE");
            }
        ...
        {
            public string opaque;
            public TransparentParamRef(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
                opaque = doc.Get<string>(node, "opaque", "A_ONE");
            }
        ...
        {
            public string opaque;
            public TransparentColor(ColladaDocument doc, XmlNode node) : base(doc , node) 
            { 
                opaque = doc.Get<string>(node, "opaque", "A_ONE");
            }
        }
        ...
        public class ParamRef : IColorOrTexture, IFloatOrParam
        {
            ...
            private ParamRef() { }
            public ParamRef(ColladaDocument doc, XmlNode node)
            {
        ...
        public class Texture : IColorOrTexture
        {
            ...
            public List<Extra> extras;
            private Texture() { }
            public Texture(ColladaDocument doc, XmlNode node)
            {
        ...
        public class Float : IFloatOrParam
        {
            ...
            private Float() { }
            public Float(ColladaDocument doc, XmlNode node)
            {
                sid = doc.Get<string>(node, "sid", null);
        ...
        public class SimpleShader
        {
            ...
            public SimpleShader(ColladaDocument doc, XmlNode node)
            {
        ...
        {
            public Constant(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        }
        /// <summary>
        ...
        {
            public Lambert(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        }
        /// <summary>
        ...
        {
            public Phong(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        }
        /// <summary>
        ...
        {
            public Blinn(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        }
        ...
        public class ProfileCOMMON : Element, IProfile   //    Note: this is missing the name attribute !
        {
            ...
            public class Technique : Element
            {
                ...
                //private technique() {}
                public Technique(ColladaDocument doc, XmlNode node)
                    : base(doc, node)
                {
            ...
            public List<Image> images;
            public Dictionary<string,NewParam> newParams;
            public ProfileCOMMON(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class Effect : Element
        {
            ...
            public Effect(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class Material : Element
        {
            ...
            public Material(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class Primitive 
        {
            ...
            private Primitive () {}
            protected Primitive(ColladaDocument doc, List<Input> _inputs, int[] _p)
            {
                p = _p;
                Inputs = _inputs;
            }
            public Primitive(ColladaDocument doc, XmlNode node)
            {
        ...
        {
            public Triangle(ColladaDocument doc, XmlNode node) : base(doc,node) {}
            public Triangle(ColladaDocument doc,  int _count, List<Input> _inputs, int[] _p)
                : base(doc, _inputs, _p)
            {
                count = _count;
            }
        ...
        {
            public Line(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        }
        /// <summary>
        ...
        {
            public Polylist(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        }
        /// <summary>
        ...
        public class Mesh
        {
            ...
            private Mesh() { }
            public Mesh(ColladaDocument doc, XmlNode node)
            {
        ...
        public class TransformNode
        {
            ...
            public TransformNode(ColladaDocument doc, XmlNode node)
            {   
                sid = doc.Get<string>(node, "sid", null);
                floats = doc.GetArray<float>(node);
            }
        ...
        {
            public Lookat(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        ...
        {
            public Matrix(ColladaDocument doc, XmlNode node) : base(doc, node) { }
            public float this[int i, int j]
            {
        ...
        {
            public Rotate(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        }
        /// <summary>
        ...
        {
            public Scale(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        }
        /// <summary>
        ...
        {
            public Translate(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        }
        /// <summary>
        ...
        {
            public Skew(ColladaDocument doc, XmlNode node) : base(doc, node) { }
        }
        /// <summary>
        ...
        public class Instance 
        {
            ...
            public string name;
            private Instance() { }
            public Instance(ColladaDocument doc, XmlNode node)
            {
        ...
        public class InstanceWithMaterialBind : Instance
        {
            ...
            public InstanceWithMaterialBind(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        {
            public InstanceCamera(ColladaDocument doc, XmlNode node) : base(doc, node) { }  // constructor
        };
        /// <summary>
        ...
        public class InstanceController : InstanceWithMaterialBind
        {
            ...
            public InstanceController(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class InstanceMaterial
        {
            ...
            public InstanceMaterial(ColladaDocument doc, XmlNode node)
            {
        ...
        public class BindMaterial : Element
        {
            ...
            public BindMaterial(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        {
            public InstanceGeometry(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
                foreach (XmlNode child in node.ChildNodes)
                {
        ...
        {
            public InstanceLight(ColladaDocument doc, XmlNode node) : base(doc, node) { } // constructor
        } ;
        /// <summary>
        ...
        {
            public InstanceNode(ColladaDocument doc, XmlNode node) : base(doc, node) { } // constructor
        } ;
        /// <summary>
        ...
        public class Node : Element
        {
            ...
            public Node(ColladaDocument doc, XmlNode root)
                : base(doc, root)
            {
        ...
        public class VisualScene : Element
        {
            ...
            public VisualScene(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class Skin : ISkinOrMorph
        {
            ...
            public Skin(ColladaDocument doc, XmlNode node)
            {
                source = new Locator(doc, node);
        ...
        public class Morph : ISkinOrMorph
        {
            ...
            public List<Extra> extras;
            public Morph(ColladaDocument doc, XmlNode node)
            {
                source = new Locator(doc, node);
        ...
        public class Controller : Element
        {
            ...
            public List<Extra> extras;
            public Controller(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class Geometry : Element
        {
            ...
            public Geometry(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class Image : Element
        {
            ...
            // private image() { }
            public Image(ColladaDocument doc, XmlNode node)
                : base(doc, node)
            {
        ...
        public class InstanceScene
        {
            ...
            public InstanceScene(ColladaDocument doc, XmlNode node)
            {
                url = new Locator(doc, node);
        ...
        /// </summary>
        public ColladaDocument(string name)
            : this()
        {
            filename = name;
